...
cl = LINETCR.LINE() # Twopay
#cl.login(qr=True)
cl.login(token='EmKKL4oNL7KJjWdarYX0.IYU1iuWA+hFqAqgLnCi/ma.DjONNfHbW2mZ8KS6i1Z+I6OBRmyeMsuo3oVpekja/ts=')
cl.loginResult()

ki = LINETCR.LINE() # Sunny
#ki.login(qr=True)
ki.login(token='EmZF3FGtJqVZmzUBqfg8.VoezRrusHbD0WdiabXEkEa.ij1hGuobI3p9Vx4Ss0IReNCMu4IsQ3wOAHiam9Fb3iQ=')
ki.loginResult()

kk = LINETCR.LINE() # Sonia
#kk.login(qr=True)
kk.login(token='Em6X4xWLFI1aHoFt34m2./95zCpt+WBgJ8aql0oE5WG.wHVAMHQruL6Ob41yreMOvdjqZlj/Dy2dd2dlSE1ZxhY=')
kk.loginResult()

kc = LINETCR.LINE() # Sonic
#kc.login(qr=True)
kc.login(token='Em50CQ1waPJeDp9s5yK4.pJjFxs531c00IsoBPdMjXa.+VkiG58FrPuaw8UGp/woiGazD6u3gROyw6OkAXARb4Q=')
kc.loginResult()

ks = LINETCR.LINE() # Sonora
#ks.login(qr=True)
ks.login(token='EmuJbGgGtCXjn20Ejj06.mHgcPi/VVlZ0yx7KEKk2rG.OZvMBrVqTxvfH1eS1hJtybe0NAnFVyrW0+wPMj6WTWo=')
ks.loginResult()

ka = LINETCR.LINE() # Sonica
#ka.login(qr=True)
ka.login(token='EmrB0vnJvJuQfBv4mMW9.ggtwX7woXCbeYYiNNkTRcq.nMOcL5AcjpDEW8qahAnhWeP5UwMb3oWBM+7ORU8wd6A=')
ka.loginResult()

kb = LINETCR.LINE() # Sonita
#kb.login(qr=True)
kb.login(token='EmML2RgGpC8H51iMFhv9.ALUuoKdQUJVN5l1i0lq9Eq.LkXjeBbN7wBTGgkzjyNK9gr0VUP0VUm2f7NkNV5aQfg=')
kb.loginResult()

ko = LINETCR.LINE() # Sonitalia
#ko.login(qr=True)
ko.login(token='EmqUaRlDElB6cC4X26G6.EZfLI+V55uUPhdXhExyFzG.fnBz4yJTw2q6nF97dTquZy8BNHX9YLwE9VARL9sIP7I=')
ko.loginResult()

ke = LINETCR.LINE() # Saras
#ke.login(qr=True)
ke.login(token='Emv9LJLMLDkkCSP2fEOb.6axbomHq5ctfXe8VSVyc2W.YKu+QcQ+CRsgRCki2QLeQPRssvDdYvniw8avURKic5A=')
ke.loginResult()

ku = LINETCR.LINE() # Sania
#ku.login(qr=True)
ku.login(token='EmCxA627MWiOVI4jeH2b.XTXtD95dwV+0BybksGOP2W.tkxC4i6QeqF3zDggIH2rfCvDTWWSkJBxfRGsWc9sPZA=')
ku.loginResult()

satpam = LINETCR.LINE() # Sani
#satpam.login(qr=True)
satpam.login(token='Emjbre7akqzpMXWl919a.eLzK/vOeDqbpTwjveN7cUG.h/51kUQLFA/aMnd2GtE5IVW/xZWs+ayUBhJW/QmLK+w=')
satpam.loginResult()
...
#k1.login(qr=True)
k1.login(token='Em73tNiF8WG6NgR7YsV7.Qgv+1dlsG/ypHl7uotUsDW.uR0HVfhi2JtZIm/mZSEHQL7Nd5CypdFzud4BUDbSsuI=')
k1.loginResult()
...
Amid = ki.getProfile().mid #Sunny
Bmid = kk.getProfile().mid #Sonia
Cmid = kc.getProfile().mid #Sonic
Dmid = ks.getProfile().mid #Sonora
Emid = ka.getProfile().mid #Sonica
Fmid = kb.getProfile().mid #Sonita
Gmid = ko.getProfile().mid #Sonitalia
Hmid = ke.getProfile().mid #Saras
Imid = ku.getProfile().mid #Sania
Smid = satpam.getProfile().mid #Sani
mid1 = k1.getProfile().mid #Backup

Bots=["u8b2bb5214c1afc77d06901a535c23e30,""ubce119ad1512841774c0320007178a78","ufbde5970f4ffc1b1a3f0040bd0e7b9c2","u3e325f5d2e77d42d3489239ba43989c4","u321182a48fafbcbcf4617ee47a42b646","u1864d6c7b58ec5c044cb22279cab6b09","u6a5b943a40eaba3be7e4bd48d0b43d79","u7b31658bfbf9e54ba91c3c4779761f66","ue805c138c850e424c5c44f2fb2f602db","uc6dc5377de435afff46d804a4a0a29db","u125664f95a0475004fb56255127ec2ba","ua8657fd432d283e60f84bed4393b9277"]
admin=["u49f93172b8c8865683dd2d47ccbb8613","u8b2bb5214c1afc77d06901a535c23e30"] # Isi Dengan Mid Admin
owner=["u49f93172b8c8865683dd2d47ccbb8613","u8b2bb5214c1afc77d06901a535c23e30"] #Isi dengan  mid Owner Plak
wait = {
    'contact':False,
    'autoJoin':True,
...
> siri tickets <
> room siri <
> vip smule bergaransi <


ṡȗƿƿȏяṭєԀ ɞʏ:
  
☆ S1B (Suara 1NDONESIA Bersatu) ☆
☆ 1SC (1ndependent SMULE community) ☆
☆ RB FAMILY ☆
☆ ☆


Minat? Silahkan PM!
Idline: http://line.me/ti/p/~mrtwopay""",
    "lang":"JP",
...
#--------------------------------
    ...
    #-----------------=Selesai=------------------ 
              ...
              if msg.from_ in admin:
            ...
            elif msg.text in ["Sunny buka qr","Sunny open qr"]:
                if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Sonic open qr","Sonic buka qr"]:
                if msg.toType == 2:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Sunny close qr","Sunny tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to, "Cek Tukang ngintip")
                try:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||Di Baca Oleh||%s\n||By : TWOPAY BOT||\n\n>Tukang ngintip<\n%s-=CCTV=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n\nAmiin Ya Allah\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ketik Intip dulu Koplak\nBaru Ketik Ciduk\nDASAR PIKUN ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","Mbot","Join kuy"]:
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------# Bot Ninggalin Group Kecuali Akun Self
            elif msg.text in ["Bye TB","Kabur all","Balik"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["Balik all"]: # Semua Ninggalin Group Termasuk Selfbotnya :D
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Start---------------#
            elif msg.text in ["Tag all","Tagall","Tega","."]:
            	 if msg.from_ in admin:
    ...
    #-------------Fungsi Tag All Finish---------------#
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Bot out","TB bye"]:
              if msg.from_ in owner:
                 #gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'u49f93172b8c8865683dd2d47ccbb8613'}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
      ...
      #-------------Fungsi Chat ----------------
            elif msg.text in ["Woy","woy","Woi","woi","bot","Bot","Pea","Gila"]:
                 quote = ['Istri yang baik itu Istri yang Mengizinkan Suaminya untuk Poligami 😂😂😂.','Kunci Untuk Bikin Suami Bahagia itu cuma satu..\nIzinkan Suamimu Untuk Selingkuh Coyyy ','Ah Kupret Lu','Muka lu kaya dodol','Aku sayang kamu','Dasar pea','Lu gila','Orang stress','Ilove you']
    ...
    for zx in range(0,20):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Mr 2pay⭐⭐👈\n\n™TWOPAY BOT™")
    ...
    for zx in range(0,20):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                ...
                print "Status Sudah di Like Pay"
